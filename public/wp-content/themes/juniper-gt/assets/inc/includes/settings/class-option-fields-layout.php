...
class Option_Fields_Layout{
  ...
  public static function options(){
		...
		$options[] = array(
			'name' => __( 'Site Full Width', 'theme-textdomain' ),
			'id' => 'site_full_width',
			'std' => 'yes',
			'type' => 'radio',
			'class' => 'mini', 
		...
		$options[] = array(
			'name' => __( 'Enable Sticky Menu', 'theme-textdomain' ),
		...
		$options[] = array(
			'name' => __( '404 Settings', 'theme-textdomain' ),
			'type' => 'heading'
		);
	   	$options[] = array(
		'name' => "404 Layout",
		...
		$options[] = array(
			'name' => __( '404 Image', 'theme-textdomain' ),
			'id'   => '404_image',
			'type' => 'upload',
		...
		$options[] = array(
			'name' => __( '404 Error Message', 'theme-textdomain' ),
		...
		$options[] = array(
			'name' => __( 'Layout Page Settings', 'theme-textdomain' ),
			'type' => 'heading'
		);	

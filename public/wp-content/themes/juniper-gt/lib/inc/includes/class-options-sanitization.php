...
/**
 * Sanitization for range  input
 
 */
function of_sanitize_range( $input ) {

		$output = wp_kses($input) ;
	    return $output;
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'grizzlytheme' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'grizzlytheme' ),
		'repeat-y'  => __( 'Repeat Vertically', 'grizzlytheme' ),
		'repeat'    => __( 'Repeat All', 'grizzlytheme' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'grizzlytheme' ),
		'top center'    => __( 'Top Center', 'grizzlytheme' ),
		'top right'     => __( 'Top Right', 'grizzlytheme' ),
		'center left'   => __( 'Middle Left', 'grizzlytheme' ),
		'center center' => __( 'Middle Center', 'grizzlytheme' ),
		'center right'  => __( 'Middle Right', 'grizzlytheme' ),
		'bottom left'   => __( 'Bottom Left', 'grizzlytheme' ),
		'bottom center' => __( 'Bottom Center', 'grizzlytheme' ),
		'bottom right'  => __( 'Bottom Right', 'grizzlytheme')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'grizzlytheme' ),
		'fixed'  => __( 'Fixed in Place', 'grizzlytheme')
		);
...
function of_recognized_font_faces() {
	$default = array(
		...
		'palatino'  => 'Palatino',
		'helvetica' => 'Helvetica*',
		'"Vincentia","Georgia",serif' => 'Vincentia',
		'Nexa,Arial,sans-serif' => 'Nexa'
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'grizzlytheme' ),
		'italic'      => __( 'Italic', 'grizzlytheme' ),
		'bold'        => __( 'Bold', 'grizzlytheme' ),
		'bold italic' => __( 'Bold Italic', 'grizzlytheme' )
		);

...
/*
  ...
  URI: http://hsameer.com.np/simple-custom-post-order/
*/
...
define( 'SCPO_URL', get_template_directory_uri().'/lib/simple-custom-post-order' );
define( 'SCPO_DIR', get_template_directory().'/lib/simple-custom-post-order/' );
